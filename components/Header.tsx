  ...
  return (
    <header className="relative mx-auto max-w-6xl p-2">
      ...
      <section className="flex items-center space-x-2 py-5 ">
        <div className="h-16 w-16 flex-shrink-0 cursor-pointer sm:w-28 md:w-44" style={{textAlign:"center",padding:"10px"}}>
          <Link href="/">
            {/* <Image
              ...
              priority
            /> */}
            <h1 style={{fontSize:"20px",fontWeight:"bold",textShadow:"0 0 11px rgab(0 164 255)"}}>
            MARKETPLACE 3.0
            </h1>
          </Link>
        </div>
